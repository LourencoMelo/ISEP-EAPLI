...
@ApplicationService
public class ConnectAgvTwinFIFOService {
    ...
    public void connectTwinFIFO(int option, Long orderId, String agvId) throws IOException {
        ...
        try {
            ...
            if (serverMessage[1] == 2) {
                ...
                byte[] clientOptionChoosen = {(byte) 0, (byte) 12, (byte) 0, (byte) 0};
