...
public class FindOrderByIdServiceTest {
    ...
    FindOrderByIdService findOrderByIdService = new FindOrderByIdService();
    ...
    public void foundOrderByIdService(){
        ...
        Optional<Order> orderOptional = findOrderByIdService.findOrderById(1);
        Order orderFind = orderOptional.get();
        assertEquals(order1, orderFind);
    }
